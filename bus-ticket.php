...
<html lang="en">
  <head>
    ...
    <title>Bus Ticket | Packages Unlimited Travels</title>
...
<section id="sec-top">
	<div class="destination-img">
		...
		<div class="container-fluid">
			<br/>
			<h2 class="destination-title">Bus Ticket</h2>
			<ol class="breadcrumb" align="center">
		      <li><a href="index.php">Home</a></li>
		      <li class="active">More Services</li>
		      <li class="active">Bus Ticket</li>
		    </ol>
		</div>
		</div>
	</div>
		...
		<div class="container">
  		<div  class="col-lg-8">
  		      <div class="block1">
                  ...
                  <hr>
                  <form class="form-horizontal " id="bus-ticket-form" method="post" action="sm-admin/ajax/query/bus-ticket-query.php" >
