...
<html lang="en">
  <head>
    ...
    <title>Pan Card Making | Destination Unlimited Travels</title>
...
<section id="sec-top">
	<div class="destination-img">
		...
		<div class="container-fluid">
			<br/>
			<h2 class="destination-title">Pan Card Making</h2>
			<ol class="breadcrumb" align="center">
		      <li><a href="index.php">Home</a></li>
		      <li class="active">More Services</li>
		      <li class="active">Pan Card Making</li>
		    </ol>
		</div>
		</div>
	</div>
		...
		<div class="container">
  		<div  class="col-lg-8">
  		      <div class="block1">
                  ...
                  <hr>
                  <form class="form-horizontal " id="pan-card-form" method="post" action="sm-admin/ajax/query/pan-card-query.php" >
      ...
      email: {
          ...
          $.ajax({
            ...
            beforeSend: function(result) {
             $('#pan-card-form button').html('<i class="fa fa-spinner fa-spin"></i>');
            },
            success: function(result) {
               $('#pan-card-form button').html(result);
          notr();
          setTimeout(function(){ window.location.href = 'pan-card-making.php' }, 1200);
