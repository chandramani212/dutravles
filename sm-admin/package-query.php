...
<title>Package Query | Destination Unlimited Travels</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Package Query</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
                  ...
                  <div id="view_week">
                    ...
                    <tr>
                      <th data-type="html">#</th>
                       ...
                       <th data-type="html" data-breakpoints="xs sm md ">Adult</th>
                       <th data-type="html" data-breakpoints="xs sm md ">Child</th>
                       <th data-type="html" data-breakpoints="xs sm md ">Sr. Citizen</th>
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from package_query where Status = 0 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo date('d M Y ', strtotime( $show['Return_Date'])); ?></td>
                          <td><?php echo $show['Adult']; ?></td>
                          <td><?php echo $show['Child']; ?></td>
                           <td><?php echo $show['Sr_Citizen']; ?></td>
               ...
               $(document).ready(function() {
                  ...
                  $('#close<?php echo $show[0]; ?>').click(function() {
                    ...
                    $.ajax({
                      type:"POST",
                      data: dataUpdate,
                      url:"ajax/Active/car-active.php",
                      success: function() {
                        location.reload();
                      }
                    });
          ...
          while($show = mysqli_fetch_array($get)) { ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $show['Child']; ?></td>
                           <td><?php echo $show['Sr_Citizen']; ?></td>
                          <td><?php echo $show['Des']; ?></td>
                             <td><?php echo date('d M Y h:i:s', strtotime($show['Time'])); ?></td>
