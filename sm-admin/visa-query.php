...
<title>Visa Query | Destination Unlimited Travels</title>
        ...
        <div class="col-md-12"> 
                  ...
                  <div id="view_week">
                    ...
                    <tr>
                      <th data-type="html">#</th>
                        ...
                        <th data-type="html" data-breakpoints="xs sm md ">Country Visit</th>
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from visa where Status = 0 order by id desc");
               ...
               $(document).ready(function() {
                  ...
                  $('#close<?php echo $show[0]; ?>').click(function() {
                    ...
                    $.ajax({
                      type:"POST",
                      data: dataUpdate,
                      url:"ajax/Active/visa-active.php",
                      success: function() {
                        location.reload();
                      }
                    });
          ...
          <?php } ?>
                  ...
                  <div id="view_week1">
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from visa where Status = 1 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
