...
<title>Pancard Query | Destination Unlimited Travels</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Pancard Query</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
          ...
          <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div id="view_week">
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from pancard where Status = 0 order by id desc");
               ...
               $(document).ready(function() {
                  ...
                  $('#close<?php echo $show[0]; ?>').click(function() {
                    ...
                    $.ajax({
                      type:"POST",
                      data: dataUpdate,
                      url:"ajax/Active/pancard-active.php",
                      success: function() {
                        location.reload();
                      }
                    });
          ...
          <?php } ?>
                  ...
                  <div id="view_week1">
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from pancard where Status = 1 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
