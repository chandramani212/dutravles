...
<title> Donation Report | Rock India Learn And Earn</title>
         ...
         <div class="row">
          ...
          <div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title">Donation Report</h3>
      ...
      <thead>
       <tr class="bg-teal-400 text-center">
        ...
        <th data-type="html" class="text-center" data-breakpoints="xs sm md">Level</th>
         <th data-type="html" class="text-center" data-breakpoints="xs sm md">Donate Amount</th>
