...
<title> TDS Report | Rock India Learn And Earn</title>
      ...
      <thead>
       <tr class="bg-teal-400 text-center">
        ...
        <th data-type="html" class="text-center" data-breakpoints="xs sm md">Level</th>
         <th data-type="html" class="text-center" data-breakpoints="xs sm md">Total Amount</th>
         <th data-type="html" class="text-center" data-breakpoints="xs sm md">Tax %</th>
        <th data-type="html" class="text-center" data-breakpoints="xs sm md"> Tax Amount</th>
     ...
     <tbody>
      <tr>
       <td>1</td>
        ...
        <td>1</td>
        <td><i class="fa fa-inr"></i> 199</td>
        <td>10 %</td>
        <td><i class="fa fa-inr"></i> 19.9</td>
        <td>03-09-2016</td>
        </tr>
