...
<title> Downline List | Rock India Learn And Earn</title>
         ...
         <div class="row">
          ...
          <div class="col-md-4">
                ...
                <div class="box-header">
                  <h3 class="box-title">Left Downline List</h3>
                ...
                <div class="box-body no-padding">
                      ...
                      <thead>
                       <tr class="bg-green-400 text-center">
                        <th class="text-center">#</th>
                        
                        <th data-type="html" class="text-center"> ID</th>
                        <th data-type="html" class="text-center">Name</th>
                        <th data-type="html" data-breakpoints="xs sm md lg" class="text-center">Level</th>
                        <th data-type="html" data-breakpoints="xs sm md lg" class="text-center">Date</th>
          ...
          <!-- /.box -->
           ...
           <!-- /.col-md-4 -->
            ...
            <div class="col-md-4">
                ...
                <div class="box-header">
                  <h3 class="box-title">Middle Downline List</h3>
                   <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                ...
                <!-- /.box-header -->
                <div class="box-body no-padding">
                      <table class="table table-xs table-bordered text-center" id="example2" data-paging="true" data-sorting="true" data-filtering="true">
                      <thead>
                       <tr class="bg-green-400 text-center">
                        <th class="text-center">#</th>
          ...
          <!-- /.box -->
           ...
           <!-- /.col-md-4 -->
             ...
             <div class="col-md-4">
                ...
                <div class="box-header">
                  <h3 class="box-title">Right Downline List</h3>
                   <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                ...
                <!-- /.box-header -->
                <div class="box-body no-padding">
                      <table class="table table-xs table-bordered text-center" id="example3" data-paging="true" data-sorting="true" data-filtering="true">
                      <thead>
                       <tr class="bg-green-400 text-center">
                        <th class="text-center">#</th>
