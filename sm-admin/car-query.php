...
<title>Car On Rent Query | Destination Unlimited Travels</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Car On Rent Query</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
                  ...
                  <div id="view_week">
                    ...
                    <tr>
                      <th data-type="html">#</th>
                        ...
                        <th data-type="html" data-breakpoints="xs md ">Mobile</th>
                        ...
                        <th data-type="html" data-breakpoints="xs sm md ">Deprature</th>
                        <th data-type="html" data-breakpoints="xs sm md ">Return</th>
                        <th data-type="html" data-breakpoints="xs sm md lg">Vehicle</th>
                        <th data-type="html" data-breakpoints="xs sm md lg">Passenger</th>
                        <th data-type="html" data-breakpoints="xs sm md lg">Message</th>
                        <th data-type="html" data-breakpoints="xs sm md ">Query Time</th>
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from car_rent where Status = 0 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo date('d M Y ', strtotime( $show['Deprature'])); ?></td>
                          <td><?php echo date('d M Y ', strtotime( $show['Return'])); ?></td>
                          <td><?php echo $show['Vehicle']; ?></td>
                          <td><?php echo $show['Passenger']; ?></td>
               ...
               $(document).ready(function() {
                  ...
                  $('#close<?php echo $show[0]; ?>').click(function() {
                    ...
                    $.ajax({
                      type:"POST",
                      data: dataUpdate,
                      url:"ajax/Active/package-active.php",
                      success: function() {
                        location.reload();
                      }
                    });
          ...
          <?php } ?>
                  ...
                  <div id="view_week1">
                    ...
                    <tr>
                      <th data-type="html">#</th>
                      <th data-type="html">Name</th>
                        <th data-type="html" data-breakpoints=" md ">Mobile</th>
                        <th data-type="html" data-breakpoints="xs sm md ">Email</th>
                        <th data-type="html" data-breakpoints="xs sm md ">From</th>
                        <th data-type="html" data-breakpoints="xs sm md ">To</th>
                        <th data-type="html" data-breakpoints="xs sm md ">Deprature</th>
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from car_rent where Status = 1 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
