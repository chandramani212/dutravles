...
<title>Add Package | Destination Unlimited Travels</title>
      ...
      <div class="row"> 
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-primary">
            ...
            <form role="form" class="form-horizontal" id="package-form" method="post" enctype="multipart/form-data" action="ajax/Add/Add-Package.php">
              <div class="box-body">
                  <div class="col-md-6">
                      <fieldset>
                          <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select class="form-control " name="select_dest" >
                                  ...
                                  <?php
                                  $getour = mysqli_query($con, "select * from destination");
                      ...
                      <fieldset>
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="fake_price" placeholder="Enter a Fake Price">
                                  </div><!-- /.input group -->
                              </div>
                            </div>
                      </fieldset>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                  <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="original_price" placeholder="Enter a Per Adult Price">
                                      </div><!-- /.input group -->
                              </div>
                            </div>
                      </fieldset>
                  ...
                  <div class="col-md-12">
                      <fieldset>
                            <div class="form-group">
                              ...
                              <div class="col-md-10">
                                <textarea class="form-control" name="description" style="height:100px; resize:vertical;"></textarea>
                              </div>
                            </div>
                      </fieldset>
                  </div>    
                  ...
                  <div class="col-md-12">
                      <fieldset>
                            <div class="form-group">
                              ...
                              <div class="col-md-10">
                                <textarea class="form-control" name="inclusions" style="height:100px; resize:vertical;"></textarea>
                              </div>
                            </div>
                      </fieldset>
                  </div>    
                  ...
                  <div class="col-md-12">
                      <fieldset>
                            <div class="form-group">
                              ...
                              <div class="col-md-10">
                                <textarea class="form-control" name="exclusions" style="height:100px; resize:vertical;"></textarea>
                              </div>
                            </div>
                      </fieldset>
                  </div>    
                  ...
                  <div class="col-md-12">
                      <fieldset>
                            <div class="form-group">
                              ...
                              <div class="col-md-10">
                                <textarea class="form-control" name="itinerary" style="height:100px; resize:vertical;"></textarea>
                              </div>
                            </div>
                      </fieldset>
                  </div>    
