...
<title>Travel Insurance Query | Destination Unlimited Travels</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Travel Insurance Query</li>
      </ol>
    </section>
        ...
        <div class="col-md-12"> 
                  ...
                  <div id="view_week">
                    ...
                    <tr>
                      <th data-type="html">#</th>
                        ...
                        <th data-type="html" data-breakpoints="xs sm md ">Date Of Birth</th>
                        <th data-type="html" data-breakpoints="xs sm md lg">Date Of Travel</th>
                        <th data-type="html" data-breakpoints="xs sm md lg">Date Of Arrived</th>
                        <th data-type="html" data-breakpoints="xs sm md ">No. Of Days</th>
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from travel_insu where Status = 0 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
                        ...
                        <tr>
                          <td><?php echo $count++; ?></td>
                            ...
                            <td><?php echo $show['DOT']; ?></td>
                            <td><?php echo $show['DOA']; ?></td>
               ...
               $(document).ready(function() {
                  ...
                  $('#close<?php echo $show[0]; ?>').click(function() {
                    ...
                    $.ajax({
                      type:"POST",
                      data: dataUpdate,
                      url:"ajax/Active/travel-insu-active.php",
                      success: function() {
                        location.reload();
                      }
                    });
          ...
          <?php } ?>
                  ...
                  <div id="view_week1">
                    ...
                    <?php
          $count = 1;
          $get = mysqli_query($con, "select * from travel_insu where Status = 1 order by id desc");
          while($show = mysqli_fetch_array($get)) { ?>
