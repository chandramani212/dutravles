...
<html lang="en">
  <head>
    ...
    <title>International Destination | Destination Unlimited Travels</title>
  ...
  .destination-img{
  	background: url(img/international.jpg) ;
...
<section id="sec-top">
	<div class="destination-img">
		...
		<div class="container-fluid">
			<br/>
			<h2 class="destination-title">International Destination</h2>
			<ol class="breadcrumb" align="center">
		      <li><a href="index.php">Home</a></li>
		      <li class="active">International Destination</li>
		    </ol>
		</div>
		</div>
	</div>
 ...
 <section id="top-destination section">
	...
	<div class="section-header">
		...
		<div class="container-fluid no-padding">
			<?php 
				$get = mysqli_query($con,"select * from destination where Dest_Type = 'International'");
